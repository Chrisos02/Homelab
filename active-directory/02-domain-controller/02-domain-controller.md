...
After reboot, verify that the domain exists.
...
- A Domain Controller should have a static IP
- AD DS requires DNS
- The domain name used in this lab is `homelab.local`
- Clients must use the Domain Controller as DNS
